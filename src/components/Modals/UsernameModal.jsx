        ...
        <form action="" className="p-4 lg:w-[80%] mx-auto" onSubmit={handleSubmit}>
           {usernameerror && 
            <div className="relative mb-2 ">
                ...
                />
                <label className="absolute text-sm text-red-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] left-2.5 peer-focus:text-red-500 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4">username</label>
            ...
            <div className="relative mb-2 ">
                ...
                value={username } onChange={(e)=>setusername(e.target.value)}
                />
                <label className="absolute text-sm text-green-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] left-2.5 peer-focus:text-green-500 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4">username</label>
                <div className="flex items-center py-1" >
