...
export default function Posts() {
  return (
    <div className='w-full'>
        <div className="bg-white lg:w-[70%] px-4 py-2 mx-auto border-y-[1px] md:border-[1px] border-gray-300 mb-2 md:rounded-lg">
            ...
            <div className="w-full max-h-96 bg-gray-200 rounded-lg overflow-hidden">
                <img src={sausage} alt="" className="w-full h-full object-cover bg-center" />
            </div>
        ...
        <div className="bg-white lg:w-[70%] px-4 py-2 mx-auto  border-y-[1px] md:border-[1px] border-gray-300 mb-2 md:rounded-lg">
            ...
            <div className="w-full max-h-96 bg-gray-200 rounded-lg overflow-hidden">
                <img src={rolex} alt="" className="w-full h-full object-cover bg-center" />
            </div>
            <div className="flex items-center py-2 text-gray-600 text-sm">
                <div className="flex items-center">
                    <AiOutlineLike className="w-6 h-6"/>
